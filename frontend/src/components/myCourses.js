...
export default function MyCourses() {
    ...
    useEffect(() => {
        ...
        async function fetcher() {
            ...
            await fetch("http://localhost:9669/user/created", {
                method: "POST",
                headers: {
    ...
    // if (userData.user=="") { return <div>Unauthorized</div>; }
    return (
        <>
                    ...
                    <tbody>
                        {
                            courses.map((course) => {
                                ...
                                return <tr>
                                    ...
                                    <td>{course.rating}</td>
                                    <th style={{ cursor: "pointer" }} ><Link to={"/course/edit/" + course.link}><a>edit</a></Link></th>
                                </tr>
                            })
                        }
                    </tbody>
